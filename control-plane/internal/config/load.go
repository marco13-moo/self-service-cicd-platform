...
func Load() *Config {
	return &Config{
		...
		GitHub:     GitHubConfig{WebhookSecret: os.Getenv("GITHUB_WEBHOOK_SECRET"), AppID: os.Getenv("GITHUB_APP_ID"), PrivateKeyPath: os.Getenv("GITHUB_PRIVATE_KEY_PATH"), CloneBaseURL: os.Getenv("GITHUB_CLONE_BASE_URL")},
